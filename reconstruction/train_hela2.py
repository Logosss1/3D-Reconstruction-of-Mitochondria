...
# 添加RTX 5090兼容性支持（必须放在torch导入之前）
try:
    # 尝试导入rtx50_compat
    import rtx50_compat
    print("✅ rtx50_compat 导入成功")
except ImportError:
    print("⚠️ rtx50_compat 未找到，将尝试使用CPU")
    pass
